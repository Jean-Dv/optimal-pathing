...
<aside class="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60 sm:w-auto">
    <div class="flex">
      <div class="flex h-screen w-16 flex-col justify-between border-e bg-white md:hidden">
        <div>
        ...
        >
          ...
          <div class="border-t border-gray-100">
            <div class="px-2">
              <div class="py-4">
                <a href="/project-programation/settings" class="t group relative flex justify-center rounded bg-blue-50 px-2 py-1.5 text-blue-700">
                  <svg
              ...
              <ul class="space-y-1 border-t border-gray-100 pt-4">
                <li>
                  <a href="/project-programation/orders"
      ...
      <div class="flex h-screen flex-1 flex-col justify-between border-e bg-white sm:hidden">
        <div class="px-4 py-6">
          <ul class="mt-14 space-y-1">
            <li>
              <a href="/project-programation/settings" class="block rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700">
                Configuración
              </a>
            </li>
            ...
            <li>
              <details class="group [&_summary::-webkit-details-marker]:hidden">
                ...
                <ul class="mt-2 space-y-1 px-4">
                  ...
                  <li>
                    <a href="/project-programation/order"
                      class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                      Agregar orden
                    </a>
                  </li>
