...
<body>
  <jsp:include page="../components/navbar.jsp">
    ...
    <jsp:param name="title" value="Agregar Responsable" />
    <jsp:param name="hrefTitle" value="responsible" />
  </jsp:include>
  <%@ include file="../components/sidemenu.jsp" %>

<main class="justify-center ml-60 max-h-screen p-8 mt-20 sm:overflow-auto sm:ml-16">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
        <div class="lg:col-span-2 lg:py-12">
          <h3 class="text-4xl text-black">Agregar Responsable</h3>
        </div>
